...
public class Exporter {
	 ...
	 * @param editorGame
	 * @param editorScenes
	 *            The {@link es.eucm.ead.schema.editor.game.EditorGame} and map
	 *            of {@link es.eucm.ead.schema.editor.actors.EditorScene}s to
	 *            export as retrieved from the model.
	 * @param callback
	...
	public void exportAsJar(String destiny, String source,
			String engineLibPath, EditorGame editorGame,
			Map<String, EditorScene> editorScenes, ExportCallback callback) {
	 ...
	 * 
	 * First, it casts {@code editorGame} to
	 * {@link es.eucm.ead.schema.game.Game} and saves it to the temp folder.
	 * 
	 * Second, it casts each
	 * {@link es.eucm.ead.schema.editor.actors.EditorScene} in
	 * {@code editorScenes} to {@link es.eucm.ead.schema.actors.Scene} and saves
	 * them to the temp folder.
	 */
	private void saveGameForExport(FileHandle destiny, EditorGame editorGame,
			Map<String, EditorScene> editorScenes) {
		// Save simplified game
		Game simplifiedGame = (Game) upcastToEngineSchema(editorGame);
		...
		scenesFH.mkdirs();
		for (Map.Entry<String, EditorScene> entry : editorScenes.entrySet()) {
	 ...
	 * 
	 * This is required by
	 * {@link #saveGameForExport(com.badlogic.gdx.files.FileHandle, es.eucm.ead.schema.editor.game.EditorGame, java.util.Map)}
