...
public class Exporter {
	 ...
	 * @param editorGame
	 * @param editorScenes
	 *            The {@link ModelEntity} representing the game.json and map of
	...
	private void saveGameForExport(FileHandle destiny, ModelEntity editorGame,
		...
		ModelEntity simplifiedGame = cloneEntityExcludingEditorComponents(editorGame);
		...
		for (Map.Entry<String, es.eucm.ead.schema.entities.ModelEntity> entry : editorScenes
				.entrySet()) {
			ModelEntity simplifiedScene = cloneEntityExcludingEditorComponents(entry
					.getValue());
