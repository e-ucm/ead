...
public class TextArea extends TextField {
	...
	/** Number of lines of this text area **/
	...
	/** Sets the number of lines that, ideally, this text area shows **/
	public void setPreferredLines(int preferredLines) {
	...
	public float getPrefHeight() {
		float prefHeight = style.font.getLineHeight() * preferredLines;
		if (style.background != null) {
			prefHeight = Math.max(
					prefHeight + style.background.getBottomHeight()
	...
	protected void drawCursor(Drawable cursorPatch, Batch batch,
		...
		cursorPatch.draw(batch, x + textOffset, y + font.getDescent()
	...
	protected void calculateOffsets() {
		...
		if (!this.text.equals(lastText)) {
			...
			float maxWidthLine = this.getWidth()
					- (style.background != null ? style.background
							.getLeftWidth() + style.background.getRightWidth()
							: 0);
			linesBreak.clear();
			int lineStart = 0;
			int lastSpace = 0;
