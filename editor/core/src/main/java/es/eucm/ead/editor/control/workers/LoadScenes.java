...
public class LoadScenes extends Worker {
	...
	protected boolean step() {
		...
		String thumbnailPath = Q.getComponent(scene, Thumbnail.class).getPath();
		String title = Q.getName(scene, "");
		result(sceneId, title, thumbnailPath);
