...
public class AddInteractionComponent extends EditionComponent{
	...
	private static final String IC_INTERACT = "ic_interactivezone",IC_FINGER = "ic_finger", IC_REC = "ic_rectangle", IC_POLYGON = "ic_polygon";
	...
	public AddInteractionComponent(EditionWindow parent, Controller controller,
		...
		Label label = new Label(i18n.m("edition.tool.add-interaction"), skin, "default-thin-opaque");
		label.setWrap(false);
	...
	protected Button createButton(Vector2 viewport, Skin skin, I18N i18n) {
		return new ToolbarButton(viewport, skin.getDrawable(IC_INTERACT), i18n.m("edition.area"), skin);
	}
