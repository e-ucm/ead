...
public class SceneGallery extends BaseGalleryWithNavigation<SceneButton> {
	...
	private static String IC_PHOTOCAMERA = "ic_photocamera",
			IC_VIDEOCAMERA = "ic_videocamera", ADD_ELEMENT_BUTTON = "ic_new";

	private static float PREF_BOTTOM_BUTTON_WIDTH = .25F;
	private static float PREF_BOTTOM_BUTTON_HEIGHT = .12F;
