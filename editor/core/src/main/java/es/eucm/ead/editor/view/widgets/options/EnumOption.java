...
public class EnumOption extends Option {
	...
	public EnumOption(Controller controller, String label, Object target,
			String field, Map<String, Object> values) {
	...
	protected Actor getOption(Skin skin) {
		return new SelectBox(values.keySet().toArray(), skin);
	}
