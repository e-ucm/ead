...
public class MoreElementComponent extends MoreComponent {
	...
	private static float PAD_TWEEN = 0.04f, LITTLE_MARGIN = 20f,
			BIG_MARGIN = 100;
	private static float PREF_BOTTOM_BUTTON_WIDTH = .12F;
	private static float PREF_BOTTOM_BUTTON_HEIGHT = .1F;

	private static String IC_SETTINGS = "ic_elementssettings",
			IC_TRASH_O = "ic_open_trash", IC_TRASH_C = "ic_close_trash";

	public static String IC_MOVE = "ic_move_tween",
			IC_ROTATE = "ic_rotate_tween", IC_SCALE = "ic_scale_tween",
			IC_ALPHA = "ic_alpha_tween";

	public static String IC_TRASH = "ic_delete", IC_TIMER = "ic_timer",
			IC_TOUCH = "ic_touch";

	private TabPanel<Button, Table> tab;
