...
/**
 * Changes a field of {@link ChangeElementEditState}
 * <dl>
 * <dt><strong>Arguments</strong></dt>
 * <dd><strong>args[0]</strong> <em>{@link Boolean}</em> the new value</dd>
 * </dl>
 * 
 */
public abstract class ChangeElementEditState extends ModelAction {

	public ChangeElementEditState() {
		super(true, false, Boolean.class);
	}
	...
	public Command perform(Object... args) {
		...
		for (Object object : objects) {
			if (object instanceof ModelEntity) {
				...
				ElementEditState elementEditState = Q.getComponent(entity,
						ElementEditState.class);
				compositeCommand.addCommand(new FieldCommand(elementEditState,
						getFieldName(), newState));
			}
		}
