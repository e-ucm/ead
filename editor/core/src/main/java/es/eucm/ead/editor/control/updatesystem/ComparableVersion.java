...
public class ComparableVersion implements Comparable<ComparableVersion> {
	...
	private static class StringItem implements Item {
		...
		private static final List<String> _QUALIFIERS = Arrays
				.asList(QUALIFIERS);
		 ...
		 */
		private static final String RELEASE_VERSION_INDEX = String
				.valueOf(_QUALIFIERS.indexOf(""));
		...
		public static String comparableQualifier(String qualifier) {
			...
			return i == -1 ? (_QUALIFIERS.size() + "-" + qualifier) : String
					.valueOf(i);
		}
		...
		public int compareTo(Item item) {
			...
			case LIST_ITEM:
				...
				while (left.hasNext() || right.hasNext()) {
					...
					// -1
					int result = l == null ? -1 * r.compareTo(l) : l
							.compareTo(r);
