...
/**
 * Does invisible the actors selected. Adds a {@link InvisibilityProperty}
 * component in {@link ModelEntity} selected.
 * <dl>
 * <dt><strong>Arguments</strong></dt>
 * <dd><strong>args[0]</strong> <em>{@link SceneEditor}</em></dd>
 * </dl>
 */
public class SetInvisibleSelection extends ModelAction {

	public SetInvisibleSelection() {
	...
	public Command perform(Object... args) {
		...
		for (Object object : objects) {
			if (object instanceof ModelEntity) {
				...
				ElementState invisible = Q.getComponent(entity,
						ElementState.class);
				compositeCommand.addCommand(new FieldCommand(actor,
						FieldName.VISIBLE, false));
				compositeCommand.addCommand(new FieldCommand(invisible,
						FieldName.INVISIBLE, true));
			}
		}
