/**
 * eAdventure is a research project of the e-UCM research group.
 *
...
public class ModelEventTest {
    ...
    public void testMerge() {
        ...
        DependencyNode[] first = new DependencyNode[]{
            dns[0], dns[1], dns[4]};
        DependencyNode[] second = new DependencyNode[]{
            dns[0], dns[1], dns[3], dns[4]};
