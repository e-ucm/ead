...
public class TextDialogTest extends UITest {
	...
	protected Actor buildUI(Skin skin, I18N i18n) {
		controller.action(ShowTextDialog.class,
				"asd asdg sdfg hg fdhg dgj fgjh fgjh fk ghjk"
						+ "sadfasg adgf dfdfhg jdfgh "
						+ "asd asdg sdfg hg fdhg dgj fgjh fgjh fk ghjk"
						+ "sadfasg adgf dfdfhg jdfgh sadfasg adgf dfdfhg");
		return new Actor();
	}
	...
	public static void main(String[] args) {
		...
		new LwjglApplication(new TextDialogTest(), config);
	}
}
