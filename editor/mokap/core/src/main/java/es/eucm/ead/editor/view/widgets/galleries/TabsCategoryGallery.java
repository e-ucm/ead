...
public class TabsCategoryGallery extends TabsGallery {
	...
	public TabsCategoryGallery(String title, Skin skin, I18N i18N) {
		this(title, SkinConstants.IC_GO, skin, i18N);
	}

	public TabsCategoryGallery(String title, String icon, Skin skin, I18N i18N) {
