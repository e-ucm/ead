...
/**
 * Removes all {@link Effect} in a {@link Behavior} </p>
 * <dl>
 * <dt><strong>Arguments</strong></dt>
 * <dd><strong>args[0]</strong> <em>{@link Behavior}</em> with the effects that
 * will be removed</dd>
 * </dl>
 */
public class ClearBehaviorEffects extends IrreversibleAction {

	public ClearBehaviorEffects() {
