...
import es.eucm.ead.editor.control.actions.editor.elementeditstate.LockSelection;
import es.eucm.ead.editor.control.actions.editor.elementeditstate.SetInvisibleSelection;
		...
		ChangeListener listener = new ChangeListener() {
			...
			public void changed(ChangeEvent event, Actor actor) {
				...
				if (listener == imageEffects) {
					...
					controller.action(LockSelection.class, true);
				} else if (listener == invisible) {
					controller.action(SetInvisibleSelection.class, true);
