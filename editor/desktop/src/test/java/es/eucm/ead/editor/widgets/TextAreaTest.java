...
public class TextAreaTest extends AbstractWidgetTest {
	...
	public AbstractWidget createWidget(Controller controller) {
		TextArea textArea = new TextArea("Write something!!", controller
				.getApplicationAssets().getSkin());
		PlaceHolder placeHolder = new PlaceHolder();
		placeHolder.setContent(textArea);
		placeHolder.setSize(600, 400);
		return placeHolder;
	}

	public static void main(String args[]) {
		new LwjglApplication(new TextAreaTest(), "Test for TextArea", 800, 600);
	}
}
