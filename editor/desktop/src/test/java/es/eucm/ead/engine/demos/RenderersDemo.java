 ...
 */
public class RenderersDemo extends EditorDemoBuilder {
	...
	protected void doBuild() {
        ...
        /*ModelEntity group = entity(getLastScene(), 300, 300)
                .getLastEntity();
        entity(getLastScene(), 200, 200).image("chameleon.png").rotation(15);*/
	}
