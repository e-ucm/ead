    ...
    extends Game
{
    ...
    private Note notes;
    /**
     * Holds the list of scenes in the order they have to be shown in the editor. For each scene its id (e.g. scene0) is stored in this array. This element has no effect whatsoever in the actual order in which scenes are displayed in the game.
     * 
     */
