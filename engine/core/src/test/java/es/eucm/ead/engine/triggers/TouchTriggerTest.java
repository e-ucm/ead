...
public class TouchTriggerTest extends TriggerTest {
	...
	/*
	 * @Test public void testPressRelease() {
	 * 
	 * Touch press = new Touch(); press.setType(Type.PRESS);
	 * 
	 * Touch release = new Touch(); release.setType(Type.RELEASE);
	 * 
	 * Empty pressEffect = new Empty(); Empty releaseEffect = new Empty();
	 * 
	 * // Press behavior Behavior pressBehavior = new Behavior();
	 * pressBehavior.setTrigger(press); pressBehavior.setEffect(pressEffect);
	 * 
	 * this.sceneElement.getBehaviors().add(pressBehavior);
	 * this.sceneElement.getBehaviors().add(pressBehavior);
	 * 
	 * // Release behavior Behavior releaseBehavior = new Behavior();
	 ...
	 * 
	 * mockGame.act(); mockGame.press(20, 580); mockGame.act();
	 * mockGame.release(20, 580); mockGame.act();
	 * 
