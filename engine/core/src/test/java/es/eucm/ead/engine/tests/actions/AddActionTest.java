...
public class AddActionTest {
	...
	public void test() {
		...
		addAction.setAction(transform);

		SceneActor scene = game.getGameLoop().getSceneView().getCurrentScene();

		scene.addAction(addAction);

		game.act();

		Array<SceneElementActor> sceneElements = scene.findByTag("tag3");
