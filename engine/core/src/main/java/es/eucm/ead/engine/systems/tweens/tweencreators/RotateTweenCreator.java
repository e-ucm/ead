...
/**
 * Creates tweens for {@link RotateTween}
 */
public class RotateTweenCreator extends TweenCreator<RotateTween> {
	...
	@Override
	public float[] getTargets(int type, RotateTween tween) {
		return new float[] { tween.getRotation() };
	}
}
