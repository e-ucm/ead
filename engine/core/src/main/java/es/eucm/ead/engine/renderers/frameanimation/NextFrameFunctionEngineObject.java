...
/**
 * This abstract class is used by {@link FrameAnimationEngineObject} to
 ...
 * And
 * 
 * {@link #getInitialFrameIndex(int)}, which returns the initial frame for the
 * animation, given the total number of frames available
 * 
 * Created by Javier Torrente on 2/02/14.
 */
public abstract class NextFrameFunctionEngineObject<T extends NextFrame>
		extends AbstractEngineObject<T> {

	/**
	 * Returns the next frame index to be rendered by
	 * {@link FrameAnimationEngineObject} , given the current frame index and
	 ...
	 * {@link FrameAnimationEngineObject} upon initialization.
	 * 
	 * @param totalFrames
	 *            The total number of frames this FrameAnimationRenderer has.
