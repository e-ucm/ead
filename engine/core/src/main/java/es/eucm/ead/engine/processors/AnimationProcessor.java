...
public class AnimationProcessor extends ComponentProcessor<Animation> {

	public AnimationProcessor(GameLoop gameLoop) {
		super(gameLoop);
	}

	@Override
	public Component getComponent(Animation component) {
