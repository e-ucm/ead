...
import es.eucm.ead.schema.components.tweens.RedTween;
import es.eucm.ead.schema.components.tweens.FieldTween;

/**
 * Creates tweens for {@link FieldTween}
 */
public class RedTweenCreator extends ColorAttributeTweenCreator<RedTween> {

	@Override
	protected float getColorAttribute(RedTween tween) {
		return tween.getRed();
	}
