 ...
 */
public class EngineAssets extends Assets {
	 ...
	 */
	public EngineAssets(Files files) {
		super(files);
	 ...
	 * {@link EngineAssets#getEngineObject(Object)}
	 * 
	 * @param gameLoop
	 *            the game loop
	 */
		...
		for (Array<String> entry : bindings) {
			if (entry.get(0).contains(".")) {
				...
				try {
					...
					Gdx.app.error("EngineAssets", "Error loading bindings", e);
					return false;
				}
			}
		}
	 ...
	 * {@link EngineAssets#newObject(Class)}
	 * 
	 * @param o
	 ...
	 * be recovered through {@link EngineAssets#popDependencies()}
	 * 
	 * @param fileName
	 * @param clazz
	 * @param <T>
