 ...
 */
public abstract class ColorAttributeTweenCreator<T extends Tween> extends
		TweenCreator<T> {

	@Override
	public Object getTarget(EngineEntity entity, T schemaTween) {
		try {
	...
	@Override
	public int getTweenType(T tween) {
		return 0;
	}

	@Override
	public float[] getTargets(int tweenType, T tween) {
		return new float[] { getColorAttribute(tween) };
	}

	protected abstract float getColorAttribute(T tween);

	protected abstract String getColorAttributeName();
}
