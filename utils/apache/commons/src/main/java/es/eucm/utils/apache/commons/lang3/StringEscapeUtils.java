...
import es.eucm.utils.apache.commons.lang3.translate.AggregateTranslator;
import es.eucm.utils.apache.commons.lang3.translate.CharSequenceTranslator;
import es.eucm.utils.apache.commons.lang3.translate.EntityArrays;
import es.eucm.utils.apache.commons.lang3.translate.JavaUnicodeEscaper;
import es.eucm.utils.apache.commons.lang3.translate.LookupTranslator;
import es.eucm.utils.apache.commons.lang3.translate.NumericEntityEscaper;
import es.eucm.utils.apache.commons.lang3.translate.NumericEntityUnescaper;
import es.eucm.utils.apache.commons.lang3.translate.OctalUnescaper;
import es.eucm.utils.apache.commons.lang3.translate.UnicodeUnescaper;
import es.eucm.utils.apache.commons.lang3.translate.UnicodeUnpairedSurrogateRemover;
...
public class StringEscapeUtils {
	 ...
	 * object allows the Java escaping functionality to be used as the
	 ...
	 * this object allows the EcmaScript escaping functionality to be used as
	 ...
	 * object allows the Json escaping functionality to be used as the
	 * foundation for a custom translator.
	 * 
	 * @since 3.2
	 */
	 ...
	 * object allows the XML escaping functionality to be used as the foundation
	 ...
	 * object allows the HTML escaping functionality to be used as the
	 * foundation for a custom translator.
	 * 
	 * @since 3.0
	 */
	 ...
	 * object allows the Java unescaping functionality to be used as the
	 * foundation for a custom translator.
	 * 
	 * @since 3.0
	 */
	// TODO: throw "illegal character: \92" as an Exception if a \ on the end of
	// the Java (as per the compiler)?
	 ...
	 * this object allows the EcmaScript unescaping functionality to be used as
	 * the foundation for a custom translator.
	 * 
	 * @since 3.0
	 */
	 ...
	 * object allows the Json unescaping functionality to be used as the
	 * foundation for a custom translator.
	 * 
	 * @since 3.2
	 */
	 ...
	 * object allows the XML unescaping functionality to be used as the
	 * foundation for a custom translator.
	 * 
	 * @since 3.0
	 */
	 ...
	 * </p>
	 * <p>
	 * Escapes any values it finds into their Json String form. Deals correctly
	 ...
	 * 
	 * <p>
	 * Though not strictly necessary, {@code escapeXml10} will escape characters
	 ...
	 * escaping. {@code escapeXml11} will remove characters that do not fit in
